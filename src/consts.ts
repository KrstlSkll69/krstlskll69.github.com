...
import { AlarmClock, BookOpen, Github, ListMusic, Plane, Printer, User, Twitter } from '@lucide/astro'
...
export const Projects: Project[] = [
    {
        start: 2023,
        title: 'Equicord',
        description: 'The other cutest Discord mod, currently the head of support and community manager.',
    ...
    },
    {
        start: 2024,
        title: 'Nest.rip',
        description: 'An image/file hosting service with a focus on privacy and security.',
        url: 'https://nest.rip/',
    },
    {
        start: 2024,
        title: 'UserPFP',
        description: 'A Discord theme/plugin that allows having animated profile pictures without Nitro.',
